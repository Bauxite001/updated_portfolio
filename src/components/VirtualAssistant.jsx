  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.94 }}
        className="fixed bottom-6 left-6 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-amber-400 shadow-lg shadow-black/40 cursor-pointer"
      >
        {open ? (
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 left-4 right-4 sm:left-6 sm:right-auto z-40 w-auto sm:w-96 max-w-full bg-black border border-gray-800 rounded-xl shadow-2xl flex flex-col overflow-hidden"
